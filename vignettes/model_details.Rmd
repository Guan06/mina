...
The first step is to import quantitative table of microbial community profiling data (e.g. OTU table) and corresponding descriptive file (e.g. design file) into the object.
To load data, use the `new()` for all avaliable file or `addTab()` and `addDes()` to import them seperately.
